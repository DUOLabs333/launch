...
class Finder(ActionsHandler):
    ...
    def show(self, input: Optional[str] = None) -> Any:
        ...
        if self.candidates.matching_candidates_len==0:
            raise AbortAction(action="abort",ch=None)
        elif self.candidates.matching_candidates_len==1:
            return self.candidates.matching_candidates[0]
